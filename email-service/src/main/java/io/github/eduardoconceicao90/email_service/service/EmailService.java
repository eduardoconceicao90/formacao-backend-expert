...
public class EmailService {
    ...
    public void sendEmail(OrderCreatedMessage order) throws Exception {
        ...
        message.setRecipients(Message.RecipientType.TO, toUsers); // Destinatários
        message.setContent(UtilEmail.messageOrderCreated(order), "text/html; charset=utf-8"); // Mensagem
